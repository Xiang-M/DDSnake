...
public class JoinRoomSubscriber {
    private final String TAG = "JoinRoomSubscriber";
    private int domain_id = 6;
    private DomainParticipant dp;
    private Subscriber sub;
    private Topic tp;
    private DataReader reader;
    private JoinRoomDataReaderListener listener;
    ...
    public JoinRoomSubscriber(DataCallback callback) {
        this.callback = callback;
        initDDS();
    }
    ...
    private class JoinRoomDataReaderListener implements DataReaderListener {
