...
import com.example.snakegame.DDSgenerated.LeaveRoomDataWriter;
...
public class LeaveRoomPublisher {
    private static final String TAG = "LeaveRoomPublisher";
    private static int DOMAIN_ID = 6;
    private static DomainParticipant dp;
    private static Publisher pub;
    private static Topic tp;
    private static LeaveRoomDataWriter writer;
...
//        dpQos.usertraffic_receive_addresses.addresses.set_at(0, "udpv4://192.168.137.0//0");
        ...
        // 注册 LeaveRoom 类型
        LeaveRoomTypeSupport ts = (LeaveRoomTypeSupport) LeaveRoomTypeSupport.get_instance();
        ...
        writer = (LeaveRoomDataWriter) dw;
        Log.d(TAG, "create data writer succeeded");
    }

    public static void sendData(LeaveRoom data) {
