...
public class JoinRoomTypeSupport extends TypeSupport {
    private String type_name = "JoinRoom";
    private static TypeCodeImpl s_typeCode = null;
    private static JoinRoomTypeSupport m_instance = new JoinRoomTypeSupport();
    ...
    public int copy_sampleI(Object dst,Object src) {
        JoinRoom JoinRoomDst = (JoinRoom)dst;
        JoinRoom JoinRoomSrc = (JoinRoom)src;
        JoinRoomDst.copy(JoinRoomSrc);
        return 1;
    }
    ...
    public int print_sample(Object _sample) {
        ...
        JoinRoom sample = (JoinRoom)_sample;
    ...
    public DataReader create_data_reader() {return new JoinRoomDataReader();}

    public DataWriter create_data_writer() {return new JoinRoomDataWriter();}
    ...
    public TypeCode get_typecode(){
        ...
        s_typeCode = factory.create_struct_TC("Supplement.JoinRoom");
        if (s_typeCode == null){
            System.out.println("create struct JoinRoom typecode failed.");
            return s_typeCode;
        }
        int ret = 0;
