...
public class PlayerColorMappingTypeSupport extends TypeSupport {
    private String type_name = "PlayerColorMapping";
    private static TypeCodeImpl s_typeCode = null;
    private static PlayerColorMappingTypeSupport m_instance = new PlayerColorMappingTypeSupport();
    ...
    private PlayerColorMappingTypeSupport(){}

    
    public static TypeSupport get_instance() { return m_instance; }

    public Object create_sampleI() {
        PlayerColorMapping sample = new PlayerColorMapping();
        return sample;
    }
    ...
    public int copy_sampleI(Object dst,Object src) {
        PlayerColorMapping PlayerColorMappingDst = (PlayerColorMapping)dst;
        PlayerColorMapping PlayerColorMappingSrc = (PlayerColorMapping)src;
        PlayerColorMappingDst.copy(PlayerColorMappingSrc);
        return 1;
    }
    ...
    public int print_sample(Object _sample) {
        ...
        PlayerColorMapping sample = (PlayerColorMapping)_sample;
    ...
    public DataReader create_data_reader() {return new PlayerColorMappingDataReader();}

    public DataWriter create_data_writer() {return new PlayerColorMappingDataWriter();}
    ...
    public TypeCode get_typecode(){
        ...
        s_typeCode = factory.create_struct_TC("Supplement.PlayerColorMapping");
        if (s_typeCode == null){
            System.out.println("create struct PlayerColorMapping typecode failed.");
            return s_typeCode;
        }
        int ret = 0;
