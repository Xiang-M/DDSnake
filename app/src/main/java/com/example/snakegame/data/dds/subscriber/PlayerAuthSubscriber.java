...
public class PlayerAuthSubscriber {
    private final String TAG = "PlayerAuthSubscriber";
    private int domain_id = 69;
    private DomainParticipant dp;
    private Subscriber sub;
    private Topic tp;
    private DataReader reader;
    private PlayerAuthDataReaderListener listener;
    ...
    public PlayerAuthSubscriber(DataCallback callback) {
        this.callback = callback;
        initDDS();
    }
    ...
    private void initDDS(){
        try {
            ...
            // 创建 DataReader -> 订阅消息
            listener = new PlayerAuthDataReaderListener();
    ...
    private class PlayerAuthDataReaderListener implements DataReaderListener {
