...
import com.example.snakegame.DDSgenerated.StartGameDataWriter;
import com.example.snakegame.DDSgenerated.StartGameTypeSupport;
...
public class StartGamePublisher {
    private static final String TAG = "StartGamePublisher";
    private static int DOMAIN_ID = 6;
    private static DomainParticipant dp;
    private static Publisher pub;
    private static Topic tp;
    private static StartGameDataWriter writer;
...
//        dpQos.usertraffic_receive_addresses.addresses.set_at(0, "udpv4://192.168.137.0//0");
        ...
        // 注册 StartGame 类型
        StartGameTypeSupport ts = (StartGameTypeSupport) StartGameTypeSupport.get_instance();
        ...
        writer = (StartGameDataWriter) dw;
        Log.d(TAG, "create data writer succeeded");
    }

    public static void sendData(StartGame data) {
